...
description: "Every template defines a metadata_schema that validates the extra_metadata field on incoming events. This schema uses JSON Schema 2020-12 and is compiled at template load time for high-performance ..."
---
