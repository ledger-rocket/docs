---
title: "Variables"
description: "Variables compute intermediate values from event data. They are evaluated sequentially before validations and legs, and their results are available to all subsequent expressions."
---
...
"variables": [
    {
        ...
        "description": "Static: Suspense account on house ledger."
    },
    {
        "name": "cash_bal_suspense",
        "value": "50050000-0000-4002-a000-000000011903",
        "description": "Static: Cash Balances - Suspense on allocation ledger."
    }
]
```

This example is from a **bank payment reconciliation** template. The suspense accounts are always the same for this site, so they are hardcoded as static variables rather than passed on each event.
...
### Bank Payment Reconciliation: Static Account Variables

```json
{
    "template_id": 103,
    "name": "bank_payment_reconciliation",
    "variables": [
        {
            "name": "suspense_account",
            "value": "50050000-0000-4001-a000-000000000004",
