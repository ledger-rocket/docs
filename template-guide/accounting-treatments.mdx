...
description: "Accounting treatments classify the financial nature of each transfer leg and link it to accounting policy documentation. Every template must declare at least one treatment, and every leg must refer..."
---
...
Used in: bank statement ingestion, sweep payment initiation, consumer fund release.
...
Used in: reconciliation flush, sweep reconciliation, bank payment reconciliation.
...
Used in: suspense resolve bank fee, control orphan resolution, suspense resolve inbound credit.
...
Used in: suspense resolve bank fee.
...
## Real-World Example: Reconciliation Flush Clearing
