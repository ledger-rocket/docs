---
title: "Ledgers"
description: "A ledger is scoped to one entity and one currency, serving as the fundamental grouping for accounts and transfers."
---
...
3. **Atomicity**: Same-ledger transfers are enforced at the storage layer.
