---
title: "Events"
description: "An event is a financial business occurrence submitted to the Event Service for processing. The Event Service validates the event, evaluates templates, and produces double-entry transfers in TigerBe..."
---
