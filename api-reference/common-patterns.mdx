...
curl -H "x-api-key: KEY" \
  "https://ledger.dev.ledgerrocket.com/v2/ledger/api/v1/sites/1/accounts?limit=50&offset=100"
```
...
```bash
# Get all HOUSE accounts with ASSET type
curl -H "x-api-key: KEY" \
  "https://ledger.dev.ledgerrocket.com/v2/ledger/api/v1/sites/1/accounts?\
entity_scope=HOUSE&account_type=ASSET"
```
...
curl -X POST -H "x-api-key: KEY" -H "Content-Type: application/json" \
  "https://ledger.dev.ledgerrocket.com/v2/ledger/api/v1/sites/1/entities/filter" \
...
curl -H "x-api-key: KEY" \
  "https://ledger.dev.ledgerrocket.com/v2/ledger/api/v1/sites/1/accounts?search=consumer"
```
